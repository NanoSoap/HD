<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="outBuyKitManage.aspx.cs" Inherits="HDpmw.productdesign.outBuyKitManage" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <f:Panel ID="mainPanel" CssClass="blockpanel" Margin="3px" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
                <Items>
                        ...
                        <Toolbars>
                            <f:Toolbar ID="Toolbar2" Position="Top" runat="server">
                                <Items>
                                    ...
                                    <f:Button ID="btnDelete" Text="删除" Icon="Delete" runat="server" ConfirmText="确定删除当前外购件？" OnClick="btnDelete_Click"></f:Button>
                        ...
                        <Items>
                            <f:Form ID="Form5" ShowBorder="false" ShowHeader="false" Title="表单" runat="server"
                                ...
                                <Rows>
                                    <f:FormRow>
                                        <Items>
                                            <f:TextBox ID="Foname" runat="server" Label="外购件名" Text=""></f:TextBox>
                    ...
                    <f:Panel runat="server" RegionPosition="Center"
                        Title="外购件列表" ShowBorder="true" ShowHeader="true" BodyPadding="1px" AutoScroll="true">
                        <Toolbars>
                        ...
                        <Items>
                            <f:Grid ID="Grid1" Title="表格" ShowBorder="false" ShowHeader="false" runat="server" PageSize="21" AllowPaging="false"
                                EnableCheckBoxSelect="true" EnableMultiSelect="false" SortDirection="ASC" SortField="oname"
                                ...
                                <Columns>
                                    ...
                                    <f:BoundField Width="200px" DataField="oname" HeaderText="名称" TextAlign="Center" SortField="oname" DataFormatString="{0}" />
                                    <f:BoundField Width="200px" DataField="ocode" HeaderText="编码" TextAlign="Center" SortField="ocode" DataFormatString="{0}" />
                                    ...
                                    <f:BoundField Width="200px" DataField="otype" HeaderText="类型" TextAlign="Center" DataFormatString="{0}" HeaderTextAlign="Center" SortField="otype" />
                                </Columns>
                            </f:Grid>
            ...
            <f:Window ID="neweditWindow" Width="750px" Height="650px" Icon="TagBlue" Title="外购件编辑" Hidden="true"
                    ...
                    <f:Panel runat="server" Layout="Region" ID="panel1" ShowHeader="false" ShowBorder="false">
                        <Items>
                            <f:Form RegionPosition="Top" BodyPadding="10px" ID="neweditForm" LabelWidth="80px" ShowBorder="false" ShowHeader="false" LabelAlign="Right"
                                ...
                                <Rows>
                                    <f:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <f:TextBox ID="oname" Label="名称" Required="true" ShowRedStar="true" runat="server" Text="">
                                            </f:TextBox>
                                            <f:TextBox ID="ocode" Label="编码" Required="true" ShowRedStar="true" runat="server" Text="">
                                            </f:TextBox>
                                    ...
                                    <f:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            ...
                                            <f:DropDownList ID="otype" Label="类型" Required="true" ShowRedStar="true" runat="server" AutoSelectFirstItem="true">
                                            </f:DropDownList>
                                        </Items>
                                    </f:FormRow>
                                    <f:FormRow>
                            ...
                            <f:SimpleForm RegionPosition="Center" ID="SimpleForm1" IsFluid="true" CssClass="blockpanel" BodyPadding="10px" EnableCollapse="false"
                                ShowBorder="true" Title="外购件图片" ShowHeader="true" runat="server">
                                <Items>
                ...
                <Toolbars>
                    <f:Toolbar ID="neweditToolbar" Position="Top" runat="server">
                        <Items>
                            ...
                            <f:TextBox ID="str_filename" Label="文件名" runat="server" Text="" Hidden="true">
                            </f:TextBox>
                        </Items>
                    </f:Toolbar>
                </Toolbars>
            </f:Window>
            <f:Window ID="photoWindow" Width="800px" Height="800px" Icon="TagBlue" Title="外购件图片" Hidden="true"
                EnableMaximize="true" EnableCollapse="false" runat="server" EnableResize="true" BodyPadding="10px" Layout="Fit"
                IsModal="true">
                <Items>
