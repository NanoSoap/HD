<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mechanicalDesignManage.aspx.cs" Inherits="HDpmw.craftdesign.mechanicalDesignManage" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <f:Panel ID="mainPanel" CssClass="blockpanel" Margin="0px" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
                <Items>
                    ...
                    <f:Panel runat="server" ID="gridPanel" RegionPosition="Left" RegionSplit="true" EnableCollapse="true" Width="270px"
                        Title="元零件库目录" ShowBorder="true" ShowHeader="true" BodyPadding="0px" AutoScroll="true">
                        <Items>
                        ...
                        <Items>
                            <f:Form ID="Form5" ShowBorder="false" ShowHeader="false" Title="表单" runat="server"
                                ...
                                <Rows>
                                    <f:FormRow>
                                        <Items>
                                            <f:TextBox ID="Fkitname" runat="server" Label="零件名称" Text=""></f:TextBox>
                                            <f:TextBox ID="Fmname" runat="server" Label="工艺卡名称" Text=""></f:TextBox>
                            ...
                            <f:Panel runat="server" EnableCollapse="true" RegionPercent="50%" RegionPosition="Top" RegionSplit="true"
                                ...
                                <Items>
                                    <f:Grid ID="Grid1" Title="表格" ShowBorder="false" ShowHeader="false" runat="server" PageSize="21" AllowPaging="false"
                                        ...
                                        <Columns>
                                            <f:BoundField Width="55px" DataField="rowno" HeaderText="序号" TextAlign="Center" />
                                            <f:BoundField Width="200px" DataField="mname" HeaderText="工艺卡名称" TextAlign="Center" SortField="mname" DataFormatString="{0}" />
                        ...
                        <Items>
                            <f:Form RegionPosition="Top" BodyPadding="10px" ID="neweditForm" LabelWidth="130px" ShowBorder="false" ShowHeader="false" LabelAlign="Right"
                                ...
                                <Rows>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            <f:TextBox Enabled="false" ID="kitname" Label="零(部)件名称" Required="true" ShowRedStar="true" runat="server" Text="">
                                            </f:TextBox>
                                            <f:TextBox Enabled="false" ID="kitcode" Label="零(部)件图号" Required="true" ShowRedStar="true" runat="server" Text="">
                                            </f:TextBox>
                                        </Items>
                                    </f:FormRow>
        ...
        <f:TextBox ID="strCloneID" runat="server" Hidden="true"  Text=""></f:TextBox>
    </form>
    ...
    <script>
        ...
        // 设置所有菜单项的禁用状态
        function setMenuItemsDisabled(hascard) {
        ...
        function onMenuShow() {
            if (currentNodeId) {
                ...
                setMenuItemsDisabled(nodeData.attrs["hascard"]);
            }
        }
